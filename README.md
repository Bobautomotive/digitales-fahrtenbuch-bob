...
- Öffentliche Probefahrten bleiben ohne Anmeldung möglich; interne Funktionen verwenden persönliche Konten.
...
- Adminfunktionen sind durch Supabase Auth, Rollen und serverseitig validierte Sessions geschützt.
...
Der Service-Role-Key bleibt ausschließlich serverseitig. Details stehen in `supabase/PHASE4_DEPLOYMENT.md`.
